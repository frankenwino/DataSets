...
def test_extracted_file_type():
    ...
    gzip_file_path = gzip_files_dir.joinpath(
...
def test_create_extract_dir():
    ...
    # Act
    e = Extractor(
        archive_file_path=gzip_file_path, extracted_file_dir=extracted_file_dir
    )
...
def test_extracted_file_path():
    ...
    # Assert
    assert ext_file_path == extracted_file_dir.joinpath(
...
def test_extract_non_gzip_file():
    ...
    # Act
    e = Extractor(
        archive_file_path=non_gzip_file_path, extracted_file_dir=extracted_file_dir
    )
    ext_file_path = e.extract_file()
